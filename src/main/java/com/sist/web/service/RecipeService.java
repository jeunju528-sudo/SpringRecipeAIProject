...
public class RecipeService {
	 ...
	 * @return 추천 레시피 목록
	 */
	public List<Map<String, Object>> recommendRecipes(List<String> ingredients) {
		 ...
		 * 유사 검색 ----------------------------------------------------
		 */
		List<Map<String, Object>> recipes = recipeMapper.findSimilarRecipes(vectorString, 5);
		...
		for (Map<String, Object> recipe : recipes) {
			 ...
			 * 조리정보
			 *
			 * 데이터에 이미지 URL이 저장되어 있다면 HTML에서 사용할 수 있다.
			 */
	...
	private List<String> extractIngredients(String content) {
		...
		String[] knownIngredients = {
				...
				"김치", "돼지고기", "소고기", "닭고기", "두부", "대파", "양파", "감자", "당근", "마늘", "계란", "우유", "치즈", "쌀", "밀가루", "라면",
				"고춧가루", "고추장", "된장", "간장", "소금", "참치", "고등어", "새우", "버섯", "새송이버섯", "청양고추", "후추", "올리브유", "두유", "생크림",
				"새싹채소" };
